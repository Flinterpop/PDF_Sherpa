...
//
// The folder is "PDFGuide", the app's first name -- it was renamed to PDF
// Sherpa and then PDFBoss.  It stays that way so settings saved before either
// rename keep working.
// Do not "fix" it.
//
...
#ifndef PDFBOSS_APP_CONFIG_H
#define PDFBOSS_APP_CONFIG_H
